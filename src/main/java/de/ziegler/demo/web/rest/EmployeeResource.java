package de.ziegler.demo.web.rest;

import de.ziegler.demo.domain.Employee;
import de.ziegler.demo.repository.EmployeeRepository;
import de.ziegler.demo.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link de.ziegler.demo.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
