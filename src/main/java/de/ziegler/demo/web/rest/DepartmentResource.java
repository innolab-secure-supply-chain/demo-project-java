...
import de.ziegler.demo.domain.Department;
import de.ziegler.demo.service.DepartmentService;
...
/**
 * REST controller for managing {@link de.ziegler.demo.domain.Department}.
 */
@RestController
@RequestMapping("/api")
